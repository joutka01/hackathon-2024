...
from net_v14_d121_auc_large_valid.a01_validation_callback import ModelCheckpoint_Stat
from net_v14_d121_auc_large_valid.a03_models_3D_pretrained import *
...
if __name__ == '__main__':
    ...
    p = MODELS_PATH + 'net_v13_3D_roi_regions_densenet121_r31_train_3D_model_dn121.py_kfold_split_large_v2_5_42/'
